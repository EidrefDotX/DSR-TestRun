...
DROP POLICY IF EXISTS "Backend access to reports" ON public.reports;
...
DROP POLICY IF EXISTS "Backend access to users" ON public.users;
...
DROP POLICY IF EXISTS "Backend access to project_defs" ON public.project_defs;
...
DROP POLICY IF EXISTS "Backend access to password_reset_tokens" ON public.password_reset_tokens;
...
DROP POLICY IF EXISTS "Backend access to login_events" ON public.login_events;
...
DROP POLICY IF EXISTS "Backend access to failed_login_attempts" ON public.failed_login_attempts;
